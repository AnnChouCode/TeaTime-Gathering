import"./main-e0cad254.js";import{a as c}from"./enc-utf8-11b5c098.js";const m="https://teatimeapi-test.onrender.com";localStorage.getItem("token");let l=document.querySelector(".takePartVoting"),r=document.querySelector(".initiatePoll"),n=document.querySelectorAll(".memberbtn");moment().format("YYYY/MM/DD");let i=[],a={};(function(){const s=c.get(`${m}/votings?_expand=restaurant`);Promise.all([s]).then(function(t){i=t[0].data,o()})})();function o(){a={},i.forEach(e=>{a[e.UID]||(a[e.UID]={UID:e.UID,restaurantId:e.restaurantId,deadlineDateTime:e.deadlineDateTime,eventDateTime:e.eventDateTime,initiator:e.initiator,invitees:e.invitees,restaurantList:e.UID.startsWith("V")?[]:[e.restaurantName],restaurantPhoto:e.restaurant.storeCover}),e.UID.startsWith("V")&&a[e.UID].restaurantList.push(e.restaurantName)}),b(),d()}function b(){let e="";for(const s in a)if(a.hasOwnProperty(s)){const t=a[s];e+=`
