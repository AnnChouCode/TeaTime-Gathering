import{b as z}from"./main-097a04cd.js";import{c as K,i as N}from"./notification-03ff7098.js";import{s as h}from"./showStars-385adb56.js";import{a as d}from"./axios-3a76d256.js";import{i as H}from"./isPastEvent-33573b9d.js";import{s as f}from"./showDateTime-51bda516.js";let E=[];const k=new Date;let P=`${k.getFullYear()}/${k.getMonth()+1}/${k.getDate()}`;Y();function Y(e){let t=`https://teatimeapi-test.onrender.com/groupings?deadlineDateTime_like=${P}&isGroup=true`;e==1&&(t="https://teatimeapi-test.onrender.com/groupings?&isGroup=true&_limit=4"),d.get(t).then(function(s){const r=s.data;if(r=="")Y(1);else if(r.forEach((n,o)=>{const[i,a]=n.deadlineDateTime.split(" ");n.datePart=i,n.timePart=a,i==P?n.todayGroupings=!0:n.todayGroupings=!1,E.push(n)}),E!=""){let n="";const o=document.querySelector(".bannerName");Q(E).then(i=>{n+=`
      ...
      `,e.length==2?t+=`
          ...
          `)),t+="</div>",t}const y="https://teatimeapi-test.onrender.com",V=localStorage.getItem("token"),L=K(V);let u=[];function Z(){const e=moment().add(2,"month").format("YYYY/MM"),s=`deadlineDateTime_gte=${moment().subtract(1,"month").format("YYYY/MM")}&deadlineDateTime_lte=${e}`,r=d.get(`${y}/groupings?_expand=restaurant&${s}`),n=d.get(`${y}/votings?_expand=restaurant&${s}`);Promise.all([r,n]).then(function(o){u=u.concat(o[0].data),u=u.concat(o[1].data),R()}).catch(function(o){console.error(o.message)})}Z();const g={};function R(){u.sort((e,t)=>{const s=new Date(e.deadlineDateTime),r=new Date(t.deadlineDateTime);return s-r}),u.forEach(e=>{g[e.UID]||(g[e.UID]={UID:e.UID,restaurantId:e.restaurantId,deadlineDateTime:e.deadlineDateTime,eventDateTime:e.eventDateTime,initiator:e.initiator,invitees:e.invitees,restaurantList:e.UID.startsWith("V")?[]:[e.restaurant.storeName],restaurantPhoto:e.restaurant.storeCover}),e.UID.startsWith("V")&&g[e.UID].restaurantList.push(e.restaurantName)}),A()}const ee=document.querySelectorAll(".btnfilterEvent"),te=document.querySelector(".calendarBlock");ee.forEach(e=>{e.addEventListener("click",function(){const t=this.getAttribute("data-event");A(t)})});function A(e="groupings"){const t=Object.values(g).filter(n=>n.UID.startsWith(e[0].toUpperCase())),s=t.filter(n=>{const o=moment(n.deadlineDateTime,"YYYY/MM/DD HH:mm");return moment().isBefore(o)});let r;s.length>=4?r=s.slice(0,4):r=t.slice(t.length-4,t.length),se(r)}function se(e){let t="";e.forEach(s=>{t+=`<div class="col-md-6 col-xl-4 col-xxxl-3">
                <a ${re(s.UID)}
                    ...
                    <div class="d-flex flex-column justify-content-between w-60 w-lg-100 flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="fs-16 fs-lg-20 lh-sm fw-medium">${s.invitees?s.invitees:"無"}</span>
                                ...
                                </div>`,t}function re(e){return e.startsWith("V")?`href="#modal-VotingModal" data-bs-toggle="modal" data-bs-votingUID="${e}"`:`href="store-order.html?UID=${e}"`}const m=document.getElementById("modal-VotingModal");function G(e){let t=[];d.get(`${y}/votings?UID=${e}&_expand=restaurant`).then(function(s){t=s.data,oe(t)}).catch(function(s){console.error(s.message)})}m.addEventListener("show.bs.modal",function(e){const s=e.relatedTarget.getAttribute("data-bs-votingUID");ie(s),G(s)});function ie(e){const t=m.querySelector(".modal-title");t.textContent=g[e].restaurantList.join("、");const s=m.querySelector(".deadlineDateTime"),r=m.querySelector(".eventDateTime"),n=m.querySelector(".initiator"),o=m.querySelector(".invitees"),i=g[e];s.innerHTML=`<span class="me-16">截止日期</span>
    ...
    <span>${f(i.eventDateTime)[1]}</span>`,n.textContent=i.initiator,o.textContent=i.invitees===""?"無":i.invitees}function oe(e){const t=m.querySelector(".votingCard"),s=H(e[0].deadlineDateTime);let r="";e.forEach(n=>{const o=n.currentVoters.includes(L),i=n.currentVoters.length,a=n.restaurant.minGroupSize;r+=`
    <li class="d-flex gap-12 p-12 mb-12 border border-brand-03 border-radius-40401616">
        <img class="border-radius-32321616 votingcard-photo" src="${n.restaurant.storeCover}">
            ...
            </li>`}),t.innerHTML=r,le()}function I(e,t){return Math.floor(e/t*100)}function ae(e,t,s){return t?'<button class="py-4 px-16 btn-disable border-0 rounded-pill btnVoteThis" disabled type="button">已結束</button>':N(V)?`<button
            ...
            type="button" data-num=${e}>${s?"已投票":"投票"}</button>`:`<button
                      ...
                      type="button" data-num=${e} data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="請先登入帳號">投票</button>`}function le(){N(V)||[...document.querySelectorAll('[data-bs-toggle="popover"]')].map(s=>{new z.Popover(s)}),m.querySelectorAll(".btnVoteThis").forEach(t=>{t.addEventListener("click",function(){this.disabled=!0,setTimeout(()=>{this.disabled=!1},3e3),t.classList.contains("btn-active-brand-02")?j(t.dataset.num,"deleteVote"):j(t.dataset.num,"addVote")})})}async function j(e,t){try{const s=document.querySelector(`.ts-progress[data-num="${e}"]`);s.classList.add("is-processing");const r=u.filter(n=>n.UID.startsWith("V")&&n.id==e)[0].currentVoters;if(t==="addVote")r.push(`${L}`);else{const n=r.indexOf(`${L}`);r.splice(n,1)}d.patch(`${y}/votings/${e}`,{currentVoters:r}).then(function(n){G(n.data.UID),s.classList.remove("is-processing")}).catch(function(n){console.error(n.message)})}catch(s){throw console.log("錯誤:",s),s}}$(".btnfilterEvent").click(function(e){$(".btnfilterEvent").toggleClass("btn-active-brand-02")});let C=document.querySelectorAll(".select-bar-link");C.forEach(e=>{e.addEventListener("click",()=>{C.forEach(t=>{t.classList.remove("btn-active-brand-02")}),e.classList.add("btn-active-brand-02")})});const W="https://teatimeapi-test.onrender.com";moment().format("YYYY/MM/DD");let p={category:"全部",sort:"",search:""};const ce={newestStore:"&_sort=id&_order=desc",bestStore:"&_sort=stars&_order=desc",worstStore:"&_sort=stars&_order=asc"};function F(e,t,s){let r="",n="",o="";e!=="全部"&&e&&(r=`category=${e}`),t&&(n=t),s&&(o=`&storeName_like=${s}`);let i=`${W}/restaurants?${r}${n}${o}`;console.log(i),me(i)}F();const de=document.querySelectorAll(".btnSortStore");de.forEach(e=>{e.addEventListener("click",function(){const t=this.getAttribute("data-sort-value");w("sort",t)})});const _=document.querySelectorAll(".btnCategoryStore");_.forEach(e=>{e.addEventListener("click",function(){const t=this.getAttribute("data-category-value");_.forEach(s=>{s.classList.remove("actived")}),w("category",t),e.classList.add("actived")})});function w(e,t){switch(e){case"category":p[e]=t;break;case"search":p[e]=t.trim();break;default:p[e]=ce[t];break}F(p.category,p.sort,p.search)}function me(e){$(function(){(function(t){let s=$("#pagination"+t);$.ajax({url:e,success:function(r){ue(r,s)},error:function(r){console.error(r)}})})("Pages")})}function ue(e,t){t.pagination({dataSource:e,totalNumber:e.length,pageSize:8,showPageNumbers:!0,showPrevious:!0,showNext:!0,callback:function(s){pe(s)}})}function pe(e){const t={飲料:"icon-park-outline:drink",速食:"mdi:food-outline",素食:"tabler:leaf",小吃:"ph:bowl-food",甜點:"material-symbols:icecream-outline-rounded",咖啡:"icon-park-outline:tea-drink"};let s='<ul class="row row-cols-2 gap-12 gap-xxl-24 findStore-ul">';e.forEach((r,n)=>{s+=`
                        ...
                        `}),s+="</ul>",document.querySelector("#paginationContainer").innerHTML=s}function fe(e){const s={isGoodStar:`<iconify-icon icon="ic:round-star" style="color: #ffd43a;"
                        width="16"></iconify-icon>`,notGoodStar:`<iconify-icon icon="ic:round-star" style="color: #c2c1bd;"
                        width="16"></iconify-icon>`};return s.isGoodStar.repeat(e)+s.notGoodStar.repeat(5-e)}const B=new autoComplete({data:{src:async e=>{try{return await(await fetch(`${W}/restaurants`)).json()}catch(t){return t}},keys:["storeName"]},searchEngine:"loose",resultItem:{highlight:!0},resultsList:{element:(e,t)=>{if(!t.results.length){const s=document.createElement("div");s.setAttribute("class","no_result px-8"),s.innerHTML=`<span>Found No Results for "${t.query}"</span>`,e.prepend(s)}},noResults:!0},events:{input:{selection:e=>{const t=e.detail.selection.value;B.input.value=t.storeName,w("search",t.storeName)},keydown:e=>{if(e.keyCode===13){const t=B.input.value;console.log(`這是 ${t}`),w("search",t)}}}}}),ge=document.getElementById("autoComplete");ge.addEventListener("input",function(e){w("search","")});const U="https://teatimeapi-test.onrender.com";let D="",O=[],J=[];function be(){const e=d.get(`${U}/messages?_sort=reviewDateTime&_order=desc`),t=d.get(`${U}/ratings?_sort=reviewDateTime&_order=desc`);Promise.all([e,t]).then(function(s){J=s[1].data,O=s[0].data,M()}).catch(function(s){console.error(s.message)})}be();function M(){window.addEventListener("resize",ve);let e=JSON.parse(JSON.stringify(J)),t=JSON.parse(JSON.stringify(O));D||(e=e.slice(0,4),t=t.slice(0,4));let s="",r="";e.forEach(i=>{const a=h(i.starRating),b=a.replace(/width="16"/g,'width="24"');s+=`
        <div
    ...
    </li>`});const n=document.querySelector(".ratingsContainer");n.innerHTML=s;const o=document.querySelector(".messagesContainer");o.innerHTML=r}let q;function ve(){clearTimeout(q),q=setTimeout(he,500)}function he(){window.innerWidth<992?(D=!0,M()):(D=!1,M())}
